...
// if 'config.yaml' not exist, read them from env
  ...
  configFile = {
    ...
    maxVideoBytes: process.env.MAX_VIDEO_BYTES,
    videoInlineMaxBytes: process.env.VIDEO_INLINE_MAX_BYTES,
    videoInputFps: process.env.VIDEO_INPUT_FPS,
...
export const Config: IConfig = {
  ...
  maxVideoBytes: Number(configFile.maxVideoBytes || 80 * 1024 * 1024),
  videoInlineMaxBytes: Number(configFile.videoInlineMaxBytes || 6 * 1024 * 1024),
  videoInputFps: Number(configFile.videoInputFps || 2),
